...
namespace Hichain.DataAccess.Data.EF
{
    public class DbCommandCustomInterceptor : DbCommandInterceptor
    {
        ...
        {
            var obj = await base.ScalarExecutingAsync(
                command,
                eventData,
                result,
                cancellationToken);
        ...
        //    return obj;
        //}
        public async override ValueTask<object> ScalarExecutedAsync(
    DbCommand command,
    ...
    CancellationToken cancellationToken = default)
        {
            ...
            var obj = await base.ScalarExecutedAsync(
                command,
                eventData,
                result,
                cancellationToken);
        ...
        public async override ValueTask<InterceptionResult<DbDataReader>> ReaderExecutingAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var obj = await base.ReaderExecutingAsync(
                command,
                eventData,
                result,
                cancellationToken);
        ...
        //    return reader;
        //}
        public async override ValueTask<DbDataReader> ReaderExecutedAsync(
    DbCommand command,
    CommandExecutedEventData eventData,
    DbDataReader result,
    CancellationToken cancellationToken = default)
        {
            ...
            var reader = await base.ReaderExecutedAsync(
                command,
                eventData,
                result,
                cancellationToken);
