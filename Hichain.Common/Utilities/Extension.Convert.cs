...
namespace Hichain.Common.Utilities
{
    ...
    public static partial class Extensions
    {
        ...
        /// </summary>
        /// <param name="str">.</param>
        /// <param name="defaultValue">The defaultValue<see cref="short"/>.</param>
        /// <returns>.</returns>
        ...
        /// </summary>
        /// <param name="str">.</param>
        /// <param name="defaultValue">The defaultValue<see cref="decimal"/>.</param>
        /// <returns>.</returns>
        ...
        /// </summary>
        /// <param name="str">.</param>
        /// <param name="result">The result<see cref="float"/>.</param>
        /// <returns>.</returns>
