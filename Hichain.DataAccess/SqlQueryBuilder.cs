...
namespace Hichain.DataAccess.Data
{
    ...
    {
        public static string CreateTableCopy(string existingTableName, string newTableName, TableInfoEx tableInfo, bool isOutputTable = false)
        {
        ...
        public static string AlterTableColumnsToNullable(string tableName, TableInfoEx tableInfo, bool isOutputTable = false)
        {
            string q = "";
        ...
        public static string CreateTable(string newTableName, TableInfoEx tableInfo, bool isOutputTable = false)
        {
            List<string> columnsNames = (isOutputTable ? tableInfo.OutputPropertyColumnNamesDict : tableInfo.PropertyColumnNamesDict).Values.ToList();
            if (tableInfo.TimeStampColumnName != null)
            {
        ...
        public static string SelectFromOutputTable(TableInfoEx tableInfo)
        {
        ...
        public static string SelectCountIsUpdateFromOutputTable(TableInfoEx tableInfo)
        {
            return SelectCountColumnFromOutputTable(tableInfo, "IsUpdate");
        }

        public static string SelectCountIsDeleteFromOutputTable(TableInfoEx tableInfo)
        {
            return SelectCountColumnFromOutputTable(tableInfo, "IsDelete");
        }

        public static string SelectCountColumnFromOutputTable(TableInfoEx tableInfo, string columnName)
        {
        ...
        public static string SelectJoinTable(TableInfoEx tableInfo)
        {
        ...
        public static string MergeTable(TableInfoEx tableInfo, OperationType operationType)
        {
